...
cd ~ pwd ls cd desktop pwd, mkdir galaxy_far_far_away
# Create a directory called `death_star`
cd galaxy_far_far_away mkdir death_star
...
# luke.txt
# ben_kenobi.txt
cd tatooine, touch luke.txt ben_kenobi.txt

# Inside of `tatooine` make a directory called `millenium_falcon`
# and in it create:
# han_solo.txt
# chewbaca.txt
mkdir millenium_falcon, cd millenium_falcon, touch hansolo.txt chewbaca.txt

# Rename `ben_kenobi.txt` to `obi_wan.txt
cd -, mv ben_kenobi.txt obi_wan.txt

# Copy `storm_trooper.txt` from `death_star` to `tatooine`
cp -R ~/desktop/galaxy_far_far_away/death_star/storm_trooper.txt ~/desktop/galaxy_far_far_away/tatooine/storm_trooper.txt
